...
function addHDYClink()
{
  ...
  if(select)
  {
    ...
    let link = '<div style="color="><li><a href = "https://hdyc.neis-one.org/?' + username[2] + '">neis-one.org : HowDidYouContribute</a></li>'+
        '<li><a href = "https://yosmhm.neis-one.org/?' + username[2] + '">neis-one.org : Where Did You Contribute (OSM Heatmap)</a></li></div>';
